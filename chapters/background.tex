...
It has a column-based storage model \cite{questdb-storage-model}.
QuestDB supports the PostgreSQL wire protocol \cite{questdb-postgres-wire} for querying and inserting data.
